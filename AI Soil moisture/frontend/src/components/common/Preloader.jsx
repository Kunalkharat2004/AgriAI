        ...
        <div className="relative text-center">
          ...
          <div className="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[110px] overflow-hidden animate-spark">
            <svg
              ...
              className="w-[110px] h-[110px] fill-[#05b717] max-sm:w-[90px] max-sm:h-[90px] "
            >
              <g>
          ...
          <div className="">
            <img
              src={logo}
              alt="medicare Logo"
              className="h-[15rem] max-sm:h-[17rem] animate-pulse-custom object-contain transform transition-none duration-200 ease-in-out scale-100 hover:scale-110"
            />
          </div>
        </div>
      </div>
